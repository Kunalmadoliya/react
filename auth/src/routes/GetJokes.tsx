...
export default function AccessTerminal() {
  const uri = "https://joke-viewer-one.vercel.app";
      ...
      >
        ...
        >
          ...
          <div className="bg-[#0c0d0e] p-6 relative">
            ...
            <div className="flex justify-between items-start mb-8 relative z-10">
              <div className="space-y-1">
                ...
                <h2 className="text-2xl font-black text-white tracking-tighter uppercase italic">
                  Joke_Archive<span className="text-blue-500">_V4</span>
                </h2>
              </div>
            ...
            {/* VISUAL PREVIEW BLOCK (JOKE THEMED) */}
            <div className="relative w-full aspect-video mb-8 bg-black border border-white/5 overflow-hidden group/image">
              <img
                src="https://images.unsplash.com/photo-1585699324551-f6c309eedee5?q=80&w=1000&auto=format&fit=crop"
                alt="Standup Microphone"
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                <div className="w-24 h-24 border border-blue-500/20 rounded-full flex items-center justify-center animate-[spin_10s_linear_infinite]">
                  <div className="w-full h-full border-t-2 border-blue-500/40 rounded-full" />
                </div>
            ...
            <div className="space-y-6 relative z-10">
              <p className="text-[11px] text-zinc-500 leading-relaxed font-medium uppercase tracking-tight">
                Initializing encrypted handshake with distributed humor nodes.
                Synchronizing Chuck Norris modules and legacy laughter
                algorithms. Warning: High-intensity satire detected in current
                payload.
              </p>
